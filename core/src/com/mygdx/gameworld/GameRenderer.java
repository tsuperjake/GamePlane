...
public class GameRenderer {
    ...
    private void initAssets() {
        ...
        planeAnimation = AssetLoader.planeAnimation;
    ...
    public void render(float runTime) {
        ...
        if (plane.shouldntFlap()) {
            batcher.draw(planeMid, plane.getX(), plane.getY(),
                    plane.getWidth() / 2.0f, plane.getHeight() / 2.0f,
                    plane.getWidth(), plane.getHeight(), 1, 1, plane.getRotation());

        } else {
            batcher.draw((TextureRegion) planeAnimation.getKeyFrame(runTime), plane.getX(),
                    plane.getY(), plane.getWidth() / 2.0f,
                    plane.getHeight() / 2.0f, plane.getWidth(), plane.getHeight(),
                    1, 1, plane.getRotation());
        }
